import {
  DomSanitizer
} from "./chunk-ENQI4QFW.js";
import "./chunk-RK54QVL3.js";
import {
  animate,
  style,
  transition,
  trigger
} from "./chunk-IFZTOPC4.js";
import {
  AsyncPipe,
  CommonModule,
  DOCUMENT,
...
_GalleryNavComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    id: [InputFlags.None, "galleryId", "id"],
    state: "state",
    config: "config"
  },
  standalone: true,
...
_SmoothScroll.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    adapter: "adapter",
    config: "config",
    interruptOnMousemove: [InputFlags.None, "smoothScrollInterruptOnMousemove", "interruptOnMousemove"]
  },
  outputs: {
...
_HammerSliding.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    enabled: [InputFlags.None, "hammerSliding", "enabled"],
    galleryId: "galleryId",
    items: "items",
    adapter: "adapter",
    state: "state",
...
_SliderIntersectionObserver.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    items: "items",
    config: "config",
    disabled: [InputFlags.None, "sliderIntersectionObserverDisabled", "disabled"]
  },
  outputs: {
    activeIndexChange: "activeIndexChange"
  },
...
_ImgRecognizer.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    index: [InputFlags.None, "galleryImage", "index"]
  },
  standalone: true
});
...
_ItemIntersectionObserver.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    adapter: "adapter",
    config: "config",
    disabled: [InputFlags.None, "itemIntersectionObserverDisabled", "disabled"]
  },
  outputs: {
    activeIndexChange: "activeIndexChange"
  },
...
_GalleryComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    id: "id",
    items: "items",
    nav: [InputFlags.HasDecoratorInputTransform, "nav", "nav", booleanAttribute],
    bullets: [InputFlags.HasDecoratorInputTransform, "bullets", "bullets", booleanAttribute],
    loop: [InputFlags.HasDecoratorInputTransform, "loop", "loop", booleanAttribute],
    debug: [InputFlags.HasDecoratorInputTransform, "debug", "debug", booleanAttribute],
    thumbs: [InputFlags.HasDecoratorInputTransform, "thumbs", "thumbs", booleanAttribute],
    counter: [InputFlags.HasDecoratorInputTransform, "counter", "counter", booleanAttribute],
    detachThumbs: [InputFlags.HasDecoratorInputTransform, "detachThumbs", "detachThumbs", booleanAttribute],
    thumbAutosize: [InputFlags.HasDecoratorInputTransform, "thumbAutosize", "thumbAutosize", booleanAttribute],
    itemAutosize: [InputFlags.HasDecoratorInputTransform, "itemAutosize", "itemAutosize", booleanAttribute],
    autoHeight: [InputFlags.HasDecoratorInputTransform, "autoHeight", "autoHeight", booleanAttribute],
    autoplay: [InputFlags.HasDecoratorInputTransform, "autoplay", "autoplay", booleanAttribute],
    disableThumbs: [InputFlags.HasDecoratorInputTransform, "disableThumbs", "disableThumbs", booleanAttribute],
    disableBullets: [InputFlags.HasDecoratorInputTransform, "disableBullets", "disableBullets", booleanAttribute],
    disableScroll: [InputFlags.HasDecoratorInputTransform, "disableScroll", "disableScroll", booleanAttribute],
    disableThumbScroll: [InputFlags.HasDecoratorInputTransform, "disableThumbScroll", "disableThumbScroll", booleanAttribute],
    thumbCentralized: [InputFlags.HasDecoratorInputTransform, "thumbCentralized", "thumbCentralized", booleanAttribute],
    disableMouseScroll: [InputFlags.HasDecoratorInputTransform, "disableMouseScroll", "disableMouseScroll", booleanAttribute],
    disableThumbMouseScroll: [InputFlags.HasDecoratorInputTransform, "disableThumbMouseScroll", "disableThumbMouseScroll", booleanAttribute],
    bulletSize: [InputFlags.HasDecoratorInputTransform, "bulletSize", "bulletSize", numberAttribute],
    thumbWidth: [InputFlags.HasDecoratorInputTransform, "thumbWidth", "thumbWidth", numberAttribute],
    thumbHeight: [InputFlags.HasDecoratorInputTransform, "thumbHeight", "thumbHeight", numberAttribute],
    autoplayInterval: [InputFlags.HasDecoratorInputTransform, "autoplayInterval", "autoplayInterval", numberAttribute],
    scrollDuration: [InputFlags.HasDecoratorInputTransform, "scrollDuration", "scrollDuration", numberAttribute],
    resizeDebounceTime: [InputFlags.HasDecoratorInputTransform, "resizeDebounceTime", "resizeDebounceTime", numberAttribute],
